    ...
    def GeneralSAMPQuestions(question):
        ...
        if question in faq:
            ...
            link = [
                    ...
                    'http://files.sa-mp.com/gtasapatch.zip',
                    'https://www.jottacloud.com/s/1729ae0c34a626c48f586f89d467fcb36e5']
            ...
            response = {
                            ...
                            'How to downgrade gta':f'**DownGrade GTA:SA**\n\n**Downgrade GTA:SA Original PC Game version**\nVersion two of GTA:SA can be downgraded to v1.0 by using a third-party path.\n*Note* the link below supports only Original version of the game NOT STEAM, MICROSOFOT / DIRECT2 DRIVE Versions\n{link[1]}\n\n**Downgrade GTA:SA Steam version**\n:arrow_right: Download the files in this link{link[2]} ( the link includes SA DOWNGRADER, ASI LOADER & SilentPatch)\n**GTA SA Downgrade Procedure**\n:arrow_right: unpack the SA DOWNGRADER\n:arrow_right: Copy \'install.bat\' & \'jptch.exe\' into the folder where your \'*GTASA.exe*\' file is & run \'*install.bat*\'.\n:arrow_right: the original file is renamed into \'*gta-sa-steam.exe*\' & there is a new .exe file called \'*gta-sa.exe*\' Choose that one.\n\n:arrow_right: Fixing some gta sa glitches using SilentPatch.\n:arrow_right: Extract the \'*SilentPatchSa*\' in the folder where your GTASA is located. To use SilentPatchSa you will need a ASI Loader.\n:arrow_right: Extract The \'*asiloader.zip*\' in rhw folder where your GTASA is located.'
            }
    ...
    def CommonSAMPErrors(question):
        ...
        if question in faq:
            ...
            response = {
                        ...
                        'San andreas not found':' SA:MP requires GTA:SA Game (v1 US/EN) to start. Versions greater than one / Direct2Drive / Microsoft Store version will not work with the multi-player functionallity',
    ...
    def SAMPGlitches(question):
        ...
        #   Responses
            ...
            response = {
                        ...
                        'Aim glitch':f'{link[question]}',
                        'Turbo knife glitch':f'{link[question]}',
                        #   Walk glitches
